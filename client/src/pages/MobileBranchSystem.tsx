          ...
          <div className="space-y-4">
            <Card className="shadow-lg">
              <CardHeader className="bg-gradient-to-r from-amber-50 to-amber-100">
                <CardTitle className="text-xl font-bold text-amber-900 text-center">التقارير</CardTitle>
              </CardHeader>
              <CardContent className="p-4">
                <div className="grid grid-cols-2 gap-4">
                  <Button 
                    className="h-24 flex flex-col items-center justify-center bg-gradient-to-br from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white shadow-lg"
                    onClick={() => setActiveSection('reports-sales')}
                  >
                    <ShoppingCart className="h-8 w-8 mb-2" />
                    <span className="text-sm font-medium">تقرير المبيعات</span>
                  </Button>
                  <Button 
                    className="h-24 flex flex-col items-center justify-center bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-lg"
                    onClick={() => setActiveSection('reports-purchases')}
                  >
                    <ShoppingBag className="h-8 w-8 mb-2" />
                    <span className="text-sm font-medium">تقرير المشتريات</span>
                  </Button>
                  <Button 
                    className="h-24 flex flex-col items-center justify-center bg-gradient-to-br from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white shadow-lg"
                    onClick={() => setActiveSection('reports-clients')}
                  >
                    <Users className="h-8 w-8 mb-2" />
                    <span className="text-sm font-medium">تقرير العملاء</span>
                  </Button>
                  <Button 
                    className="h-24 flex flex-col items-center justify-center bg-gradient-to-br from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white shadow-lg"
                    onClick={() => setActiveSection('reports-suppliers')}
                  >
                    <Users className="h-8 w-8 mb-2" />
                    <span className="text-sm font-medium">تقرير الموردين</span>
                  </Button>
                  <Button 
                    className="h-24 flex flex-col items-center justify-center bg-gradient-to-br from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white shadow-lg"
                    onClick={() => setActiveSection('reports-products')}
                  >
                    <Package className="h-8 w-8 mb-2" />
                    <span className="text-sm font-medium">تقرير المنتجات</span>
                  </Button>
                  <Button 
                    className="h-24 flex flex-col items-center justify-center bg-gradient-to-br from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white shadow-lg"
                    onClick={() => setActiveSection('reports-inventory')}
                  >
                    <Package className="h-8 w-8 mb-2" />
                    <span className="text-sm font-medium">تقرير المخزون</span>
                  </Button>
                  <Button 
                    className="h-24 flex flex-col items-center justify-center col-span-2 bg-gradient-to-br from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white shadow-lg"
                    onClick={() => setActiveSection('reports-employees')}
                  >
                    <Users className="h-8 w-8 mb-2" />
                    <span className="text-sm font-medium">تقرير الموظفين</span>
                  </Button>
                </div>
                <Button 
                  variant="outline"
                  className="w-full mt-4 border-amber-500 text-amber-700 hover:bg-amber-50"
